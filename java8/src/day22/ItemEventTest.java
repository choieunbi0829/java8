...
//		setLayout(new GredLayout(2,2));
		...
		jpanel.setBorder(new TitledBorder(new EtchedBorder(), "증권회사 구분"));
		jpanel.add(hBox);
		//수평으로 컴포넌트 추가
		...
		JPanel jjpanel = new JPanel(new BorderLayout());
		jjpanel.setBorder(new TitledBorder(new EtchedBorder(), "은행 구분"));
		jjpanel.add(hhBox);
